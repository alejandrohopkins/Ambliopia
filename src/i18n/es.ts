...
export const es = {
  ...
  articulos: {
    ...
    'casco-conejo': 'Orejas de conejo',
    'casco-auriculares': 'Auriculares',
    'casco-unicornio': 'Cuerno de unicornio',
    'casco-flores': 'Corona de flores',
    ...
    'traje-arcoiris': 'Traje arcoíris',
    'traje-menta': 'Traje menta',
    'traje-fresa': 'Traje fresa',
    'traje-cobre': 'Traje cobre',
    'traje-noche': 'Traje noche',
    'traje-sol': 'Traje atardecer',
    'traje-bosque': 'Traje bosque',
    ...
    'mascota-fenix': 'Fénix',
    'mascota-pinguino': 'Pingüino',
    'mascota-perrito': 'Perrito',
    'mascota-panda': 'Panda',
  ...
  tienda: {
    ...
    probar: 'Probar',
    probarArticulo: (nombre: string) => `Probar ${nombre}`,
    probando: (nombre: string) => `Te estás probando: ${nombre}`,
    tuAvatar: 'Así vas ahora. Prueba lo que quieras antes de comprarlo.',
    quitarPrueba: 'Quitar la prueba',
  },

  avatar: {
    titulo: 'Mi avatar',
    explicacion: 'Elige lo que llevas puesto. Todo lo que compres aparece aquí.',
    apariencia: 'Tu apariencia',
    piel: 'Tono de piel',
    pelo: 'Color de pelo',
    pieles: {
      'piel-clara': 'Clara',
    ...
    pelos: {
      'pelo-castano': 'Castaño',
      'pelo-negro': 'Negro',
      'pelo-rubio': 'Rubio',
      'pelo-pelirrojo': 'Pelirrojo',
      'pelo-lila': 'Lila',
      'pelo-azul': 'Azul',
    } as Record<string, string>,
  },
